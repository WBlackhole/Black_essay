...
\usepackage{subfig}               % 加载 subfigure 宏包，用于在同一行中插入多个子图
...
-\numberwithin{equation}{section}  % 使公式编号以章节号为前缀
-\numberwithin{table}{section}     % 使表格编号以章节号为前缀
-\numberwithin{figure}{section}    % 使图形编号以章节号为前缀
\renewcommand{\theequation}{\thesection-\arabic{equation}} % 将公式编号前缀改为“1-1”
\renewcommand{\thetable}{\thesection-\arabic{table}}       % 将表格编号前缀改为“1-1”
\renewcommand{\thefigure}{\thesection-\arabic{figure}}     % 将图形编号前缀改为“1-1”
