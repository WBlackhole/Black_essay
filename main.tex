...
\usepackage[superscript]{cite}   % 让引用变成上标
...
\pagestyle{plain} 
\include{毕业论文/body/abstract.tex}
\pagestyle{empty}
\tableofcontents 
\thispagestyle{empty}
...
%============== 论文正文   =================
\pagestyle{fancy}
\include{毕业论文/body/chapter1.tex}
\include{毕业论文/body/chapter2.tex}
\include{毕业论文/body/chapter3.tex}
\include{毕业论文/body/chapter4.tex}
\include{毕业论文/body/chapter5.tex}
...
\newblock The lung image database consortium (lidc) and image database resource
  ...
  scans.
\newblock {\em Medical physics}, 38(2):915--931, 2011.

\bibitem{drozdzal2016importance}
...
\newblock {\em arXiv preprint arXiv:1707.07958}, 2017.
...
\newblock {\em arXiv preprint arXiv:1709.07330}, 2017.
...
\newblock {\em IEEE transactions on medical imaging}, 35(5):1299--1312, 2016.

\bibitem{Zhou_2017_CVPR}
...
%=============  致谢  ======================
\include{毕业论文/body/acknowledge.tex}
%===================   结束正文    ===============================================================
\end{document}