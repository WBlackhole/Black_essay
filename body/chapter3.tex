...
本研究共使用到三个数据集：ISIC皮肤镜影像数据集、LiTS肝脏CT数据集和BraTS脑肿瘤数据集。

\begin{figure}[htbp]
    \centering
    \subfloat[皮肤镜图像（ISIC）]
    {
        \includegraphics[height=6cm]{fig/ISIC.png}
    }
    \subfloat[肝脏CT影像（LiTS）]
    {
        \includegraphics[height=6cm]{fig/LiTS.png}
    }
    \subfloat[脑部MRI图像（BraTS）]
    {
        \includegraphics[height=6cm]{fig/brain.pdf}
    }
\end{figure}
