...
\begin{figure}[htbp]
    ...
    \subfloat[皮肤镜图像（ISIC）]
    {
        \includegraphics[width=0.3\textwidth,height=6cm]{fig/ISIC.png}
    }
    \hspace{0.3cm}
    \subfloat[肝脏CT影像（LiTS）]
    {
        \includegraphics[width=0.3\textwidth,height=6cm]{fig/LiTS.png}
    }
    \hspace{0.3cm}
    \subfloat[脑部MRI图像（BraTS）]
    {
        \includegraphics[width=0.3\textwidth,height=6cm]{fig/brain.pdf}
    }
